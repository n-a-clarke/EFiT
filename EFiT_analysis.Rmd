...
group_descriptive_table$tinnitus <- signif(group_descriptive_table$tinnitus,2)
...
group_descriptive_table$`bothersome tinnitus` <- signif(group_descriptive_table$`bothersome tinnitus`,2)
