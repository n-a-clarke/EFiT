...
RIF_RpPlus_scaled_posterior_samples <- spread_draws(bayes_RIF_RpPlus_lm_tincats_scaled, c(THI_cat3, THI_cat2), seed = 123)
...
RIF_RpMinus_scaled_posterior_samples <- spread_draws(bayes_RIF_RpMinus_lm_tincats_scaled, c(THI_cat3, THI_cat2), seed = 123)
...
RIF_Np_scaled_posterior_samples <- spread_draws(bayes_RIF_Np_lm_tincats_scaled, c(THI_cat3, THI_cat2), seed = 123)
...
rbind.data.frame(rank_bayes_RIF_RpPlus_lm_tincats_scaled, rank_bayes_RIF_RpMinus_lm_tincats_scaled, rank_bayes_RIF_Np_lm_tincats_scaled) %>% 
  filter(IV == "RRS_scaled")#create RRS coefficient table


tin_RIF_table_plus <- rank_bayes_RIF_RpPlus_lm_tincats_scaled %>% 
  filter(IV == "THI_cat2" | IV == "THI_cat3")

tin_RIF_table_minus <- rank_bayes_RIF_RpMinus_lm_tincats_scaled %>% 
  filter(IV == "THI_cat2" | IV == "THI_cat3")

tin_RIF_table_Np <- rank_bayes_RIF_Np_lm_tincats_scaled %>% 
  filter(IV == "THI_cat2" | IV == "THI_cat3")

all_tin_RIF_table <- rbind(tin_RIF_table_plus, tin_RIF_table_minus, tin_RIF_table_Np) 


recode(all_tin_RIF_tablw$IV, "THI_cat2" == "tinnitus")
