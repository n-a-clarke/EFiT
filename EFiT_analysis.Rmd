...
bayes_bothersome_tinnitus_rank <- bayes_bothersome_tinnitus_rank %>% 
  mutate(worse_non_zero_prob = c(matrixReason_partial_beta_prob_bothersome_tinnitus,
...
bayes_bothersome_tinnitus_rank <- bayes_bothersome_tinnitus_rank %>% mutate(better_non_zero_prob = 1-worse_non_zero_prob)
...
bayes_tinnitus_rank <- bayes_tinnitus_rank %>% 
  mutate(worse_non_zero_prob = c(matrixReason_partial_beta_prob_tinnitus,
           ...
           switchCost_partial_beta_prob_tinnitus,ruleErr_partial_beta_prob_tinnitus,
           stroopRT_partial_beta_prob_tinnitus))

bayes_tinnitus_rank <- bayes_tinnitus_rank %>% mutate(better_non_zero_prob = 1-worse_non_zero_prob)
