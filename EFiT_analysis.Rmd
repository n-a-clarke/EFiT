...
##Controls and Modsev
###Number-letter sequencing
```{r control-modsev t-test letter-number sequencing}
t.test(controls$nls_correct, modsev_tin$nls_correct, alternative = "greater",var.equal = F)#controls greater than modsev
```
...
###Keep-track
```{r control-modsev t-test keep-track}
...
###Stroop
####Response time (incongruent)
```{r control-modsev t-test stroop}
t.test(controls$stroop_incongruent, modsev_tin$stroop_incongruent, alternative = "less",var.equal = F)#controls less than modsev
```
...
####Errors
```{r control-modsev t-test stroop errors}
t.test(controls$stroop_errors, modsev_tin$stroop_errors, alternative = "less",var.equal = F)#controls less than modsev
```
...
###Retrieval-induced forgetting
```{r control-modsev t-test retrieval-induced forgetting}
...
t.test(controls$switch_cost, modsev_tin$switch_cost, alternative = "less",var.equal = F)#controls less than modsev
```
...
t.test(controls$rule_errors, modsev_tin$rule_errors, alternative = "less",var.equal = F)#controls less than modsev
```
...
###Dual task
```{r control-modsev t-test dual task}
t.test(controls$dual_task_total, modsev_tin$dual_task_total, alternative = "greater",var.equal = F)#controls greater than modsev
```
...
nls_mild_modsev_t.test_tidy <- tidy(nls_control_mild_t.test)
```
Welch two-sample t-test for number-letter sequencing task shows that...
...
t.test(mild_tin$stroop_incongruent, modsev_tin$stroop_incongruent, alternative = "less",var.equal = F)#mild less than modsev
```
...
t.test(mild_tin$stroop_errors, modsev_tin$stroop_errors, alternative = "less",var.equal = F)#mild less than modsev
```
...
t.test(mild_tin$switch_cost, modsev_tin$switch_cost, alternative = "less",var.equal = F)#mild less than modsev
```
...
t.test(mild_tin$rule_errors, modsev_tin$rule_errors, alternative = "less",var.equal = F)#mild less than modsev
```
...
t.test(mild_tin$dual_task_total, modsev_tin$dual_task_total, alternative = "greater",var.equal = F)#mild greater than modsev
```
